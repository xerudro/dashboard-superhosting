...
DROP FUNCTION IF EXISTS public.update_updated_at_column(trigger) CASCADE;
DROP FUNCTION IF EXISTS public.update_currency_rate_updated_at(trigger) CASCADE;
DROP FUNCTION IF EXISTS public.log_currency_rate_change(trigger) CASCADE;
...
-- Create has_role function with explicit parameter names
...
-- Create has_permission function with explicit parameter names
